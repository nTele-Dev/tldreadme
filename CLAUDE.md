...
- **roadmap.py** — Human-first planning layer. Captures timestamped `TLDRPLANS.*.md` note drops, consolidates `TLDRPLANS.md`, and generates `TLDROADMAP.md` from README intent, workboard state, and grounded planning signals.
